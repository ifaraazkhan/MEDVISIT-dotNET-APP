<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="MD_Clinic.Dashboard" %>

<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlace_breadcrumb">
                <!-- Breadcrumb -->
								...
								<div class="col-md-12">
									...
									<div class="appointment-tab">
										...
										<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
											<li class="nav-item">
												<a class="nav-link active" href="#upcoming-appointments" data-toggle="tab">Request</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="#today-appointments" data-toggle="tab">Appointments</a>
											</li> 
										 
											<li class="nav-item">
												<a class="nav-link" href="#today-appointments" data-toggle="tab">Cancelled</a>
											</li> 
										</ul>
										<!-- /Appointment Tab -->
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				...
																				<a href="">John Doe <span>#MV1234</span></a>
																			</h2>
																		</td>
																		<td>11 Feb 2021 <span class="d-block text-info">10.00 AM</span></td>
																		<td>General</td>
																		<td>New Patient</td>
																		<td class="text-center"><span class="badge badge-primary" style="font-size: 20px;">8574151908</span></td>
																		<td class="text-right">
																	...
																	<tr>
																		...
																		<td class="text-right">
																			<div class="table-action">
																				<a href="javascript:void(0);" class="btn btn-sm bg-info-light" data-toggle="modal" data-target="#appt_details">
																					<i class="far fa-eye"></i> View
																				</a>
																				
																				<a href="javascript:void(0);" class="btn btn-sm bg-success-light" data-toggle="modal" data-target="#appt_accepts">
																					<i class="fas fa-check"></i> Accept
																				</a>
																				<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																					<i class="fas fa-times"></i> Cancel
