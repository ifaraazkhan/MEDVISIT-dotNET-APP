...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="ContentPlaceHolder_mainArea">
    <div class="col-md-7 col-lg-8 col-xl-9">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <div class="row">
                    <div id="listview_div" runat="server" class="col-md-12">
                        <div class="row">
                            <div class="col-12 col-sm-4 col-md-4">
                                <h4 class="mb-1">
                                    <asp:Label ID="lbl_today_date" runat="server" Text=""></asp:Label></h4>
                                <p class="text-muted">
                                    <asp:Label ID="lbl_today_day" runat="server" Text=""></asp:Label>
                                </p>
                            </div>
                            <div class="col-12 col-sm-4 col-md-4">
                                 <div class="alert alert-success alert_calendar" role="alert" style="display:none">
                                                    ...
                                                    <asp:Repeater runat="server" ID="rptSection1" OnItemDataBound="rptSection1_ItemDataBound" OnItemCommand="rptSection1_ItemCommand">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btn_available1" runat="server" Text='<%# String.Format("{0} - {1}", Eval("start_time"), Eval("end_time")) %>'
                                                                class="timing bg-success-light" CommandName="un_available" CommandArgument='<%# String.Format("{0}", Eval("start_time")) %>' />
                                                            <asp:Button ID="btn_unavailable1" runat="server" Text='<%# String.Format("{0} - {1}", Eval("start_time"), Eval("end_time")) %>'
                                                                class="timing bg-danger-light" CommandName="_available" CommandArgument='<%# String.Format("{0}", Eval("start_time")) %>' Visible="false" />
                    ...
                    <div id="settings_div" runat="server" visible="false">
                        <div class="card">
								<div class="card-body">
                                    <center>
                                        <h4 class="card-title">You have not entered basic settings , Please complete basic <a href="Settings.aspx" class=""><span class="badge badge-danger">settings</span></a> first </h4>
                                    </center>
